# ===========================================================================
# Simulation Study: TMLE with Binary Outcome (3 Time Points)
# ===========================================================================
#
# Verifies longy's TMLE estimator (backward ICE + quasibinomial fluctuation
# + EIF inference) for binary outcomes. Uses EIF-based SE (no bootstrap).
...
#
# Usage:
#   source("longy/simulations/sim_tmle_binary.R")

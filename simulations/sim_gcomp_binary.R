# ===========================================================================
# Simulation Study: G-comp with Binary Outcome (3 Time Points)
# ===========================================================================
#
# Verifies longy's G-computation estimator (backward ICE) for binary
# outcomes. Point estimates only (bootstrap too slow for simulation study).
# Reports bias and RMSE.
#
# Two DGP variants toggleable via use_ylag (see sim_ipw_binary.R for
# full DGP documentation):
#
#   use_ylag = FALSE: No outcome feedback. Simple DGP.
#   use_ylag = TRUE:  Y(t-1) feeds back into L, A, Y (coefficients 0.3, 0.3, 0.5).
#
# Usage:
#   source("longy/simulations/sim_gcomp_binary.R")

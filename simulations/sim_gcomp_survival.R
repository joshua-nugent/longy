# ===========================================================================
# Simulation Study: G-comp with Survival Outcome (3 Time Points)
# ===========================================================================
#
# Verifies longy's G-computation estimator (backward ICE) for survival
# (absorbing binary) outcomes. Point estimates only. Reports bias and RMSE.
...
#
# Usage:
#   source("longy/simulations/sim_gcomp_survival.R")
